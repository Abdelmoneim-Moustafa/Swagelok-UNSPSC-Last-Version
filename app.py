...
# Page config and custom styles for a professional look with light/dark mode support
st.set_page_config(page_title="Swagelok UNSPSC Scraper", page_icon="🔍", layout="wide")
st.markdown("""
    <style>
    /* Hide default streamlit elements that create lines */
    ...
    /* Error card - adapts to theme */
    .error-card {
        background: color-mix(in srgb, #f44336 15%, var(--background-color));
    ...
    /* Remove extra spacing and lines */
    .stProgress > div > div {
        margin-bottom: 0;
    }
